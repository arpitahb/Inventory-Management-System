...
class categoryClass:
    def __init__(self,root):
        ...
        self.ent1=StringVar()
        self.ent2=StringVar()
        label3 = Label(self.root, text="Product Category", font=("Arial", 30), bg="#414C6B", fg="white").place(x=10,
                                                                                                               y=10,
                                                                                                               height=50,
                                                                                                               width=580)
        ...
        search = ttk.Combobox(self.root, textvariable=self.ent1,
                              values=("Select", "Product Category", " Product Name", "Supplier Name"), state="readonly",
